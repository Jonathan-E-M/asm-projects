...
main PROC
        ...
        ja      above              ;signed jump, ja, taken since 10 > 5 (ZF=0,CF=0)
...
nextExample:
        ...
        ja      above2             ;ja not taken since 5 == 5 and above jump was taken
        
        ;since op1 == op2, the above jumps are not taken and the following line executes
